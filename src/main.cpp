...
/*
 * To select the softAP connection select the next two
 * const definitions and define  NETWORK_CONNECTION  1
 */
...
/*
 * To select the network  connection select the next two
 * const definitions and define  NETWORK_CONNECTION  0
 */
